...
#include "../../../../gui/tools/moduletools/progresswindow.h"
...
QT_MOC_LITERAL(1, 15, 22), // "notify_action_progress"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 11) // "std::string"

    },
    "progresswindow\0notify_action_progress\0"
    "\0std::string"
};
...
void progresswindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->notify_action_progress((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2]))); break;
        default: ;
        }
    }
}
